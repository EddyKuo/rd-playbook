...
> **前置閱讀**:[第 6 章｜可讀性:為下一個人而寫](./ch-06-readability.md)
> **下游章節**:[第 8 章｜控制複雜度](./ch-08-complexity.md)

## 7.1 共感現場:那個大家都說「懂」的函式
...
- **前一章**:[第 6 章｜可讀性:為下一個人而寫](./ch-06-readability.md) ⸺ 可讀性的基礎概念,與本章的命名原則互相支撐
- **下一章**:[第 8 章｜控制複雜度](./ch-08-complexity.md) ⸺ 邊界畫好之後,條件與巢狀的控制
- **強連結**:[第 9 章｜重構的時機與安全網](./ch-09-refactoring.md) ⸺ 命名不對、邊界模糊時,如何安全地重整
- **強連結**:[第 17 章｜Code Review:看什麼、怎麼給回饋](../part-04-collaboration/ch-17-code-review.md) ⸺ 命名品質是 code review 最容易發現、也最值得討論的向度
