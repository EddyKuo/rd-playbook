...
# 第 46 章｜判斷力的養成:當階梯被 AI 抽掉
## ⸺ L1 能跑、L2 合慣例、L3 設計對、L4 架構美——四層爬升,刻意練習

> **前置閱讀**:[第 42 章｜AI 時代的工程師心智與責任界線](../part-08-ai-era/ch-42-engineer-mindset.md)、[第 28 章｜向下穿透抽象層](../part-06-operations/ch-28-penetrating-abstraction.md)
> **下游章節**:[第 47 章｜研發者的成長路徑](./ch-47-growth-path.md)
...
不過前三個機制有一個共同的隱藏前提:必須有人主動去執行它們。把 Generate 當訓練需要新人願意先想過再送出,拷問 AI 需要新人記得追問,現實裁判需要新人願意主動去找那個會痛的情境——這三件事,都要求新人自己有意識地啟動。可是新人剛入行的時候,往往連「我該問什麼」都還說不清楚,更別說主動去製造一個會讓自己痛的測試。這就是機制四為什麼不可替代:自然階梯斷了,資深者的帶法也必須跟著改變。

以前的帶法可以很被動:等新人提問、等 Code Review 的時候說。這樣是有效的,因為新人在自己做的過程中會撞到問題,然後帶著問題來。

現在新人可能很久都撞不到問題——因為 AI 幫他繞過去了。所以資深者需要更主動地「製造問題」給新人撞:

- 可以定期安排一對一的「技術拷問」時間:「你上週那個 schema,能不能說說為什麼這樣設計?如果改成另一種,會有什麼不同?」
- Code Review 時,除了挑出問題,也可以多問一句「為什麼」:「這裡你選 X 而不是 Y,是有什麼考量嗎?」讓新人練習說出取捨的語言。
- 試著帶他們完整走一次負載測試或邊界分析,讓他們親眼看到數字。

這些事,以前靠環境「自動提供」;現在必須靠資深者「刻意創造」。也就是說,如果組織認為「有 AI 了,junior 的活 AI 能做,不需要請太多新人」,那條斷掉的階梯就沒有人去修——資深者的角色,在 AI 時代反而變得更不可或缺。
...
### 46.5.1 範例:NovaDeskAI 彈性表單模組的事後自查
...
- **前一章**:[第 45 章｜接手 legacy 系統的 90 天計畫](./ch-45-legacy-90-days.md) ⸺ 接手時需要的正是 L3~L4 判斷力
- **下一章**:[第 47 章｜研發者的成長路徑](./ch-47-growth-path.md) ⸺ 判斷力的養成是成長路徑的核心軸線
- **強連結**:[第 1 章｜為什麼工程實作需要決策框架](../part-01-foundations/ch-01-why-engineering-decisions.md) ⸺ 本書的起點:「能跑」只是判斷的第一層
- **強連結**:[第 28 章｜向下穿透抽象層](../part-06-operations/ch-28-penetrating-abstraction.md) ⸺ broken ladder 的歷史先例,抽象層移除了「被逼著向下鑽」的養成時刻
- **強連結**:[第 38 章｜審查 AI 生成的程式碼](../part-08-ai-era/ch-38-reviewing-ai-code.md) ⸺ 機制二「主動拷問 AI」的操作細節在此展開
- **強連結**:[第 42 章｜AI 時代的工程師心智與責任界線](../part-08-ai-era/ch-42-engineer-mindset.md) ⸺ 更廣的心智框架,本章是其具體落地
