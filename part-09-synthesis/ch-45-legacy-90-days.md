...
# 第 45 章｜接手 legacy 系統的 90 天計畫
## ⸺ 先讀懂它在解決什麼問題,再談要不要改

> **前置閱讀**:[第 2 章｜讀懂一份陌生程式碼](../part-01-foundations/ch-02-reading-unfamiliar-code.md)、[第 9 章｜重構的時機與安全網](../part-02-craft/ch-09-refactoring.md)
> **下游章節**:[第 46 章｜判斷力的養成:當階梯被 AI 抽掉](./ch-46-cultivating-judgment.md)、[第 27 章｜從告警到根因:生產環境除錯](../part-06-operations/ch-27-alert-to-rootcause.md)
...
這三個維度不是平等並列的,遇到衝突時需要一個判斷順序——這也是為什麼你不能只靠「感覺」來排優先序。業務損失敏感度關乎金錢或安全,一旦出錯的代價通常無法挽回,所以優先度最高;使用頻率關乎影響範圍的廣度,次之;外部介面耦合則像是一個複雜度倍數——它本身不決定優先序,但會放大前兩者的風險。也就是說,當維度彼此衝突時,判斷順序是:**業務損失敏感度 > 使用頻率 > 外部介面耦合**。順著這個道理,把三個維度綜合起來,下面的決策表幫你做優先順序:
...
改善候選(來自第一階段筆記):
  ...
  3. 更新 README,補上「本機啟動」與「環境變數清單」
     ...
     <!-- 這項按 44.3.3 的嚴格標準,其實排不進「最值得投入」的名單——
          它沒有讓系統容易出事,也沒有讓下一個改動變困難。放進候選清單
          是因為它 1-2 天就能完成,可以和第一項的大改動並行推進,
          讓主管在等待大改動的同時也看到具體進展。真正優先的仍是
          第一項和第二項。 -->
...
- **前一章**:[第 44 章｜一次生產事故的完整復盤](./ch-44-incident-postmortem.md) ⸺ 事故復盤裡常見的問題,很多起點都在 legacy 系統的技術債
- **下一章**:[第 46 章｜判斷力的養成:當階梯被 AI 抽掉](./ch-46-cultivating-judgment.md) ⸺ 接手 legacy 系統是培養 L3/L4 判斷力的天然環境
- **強連結**:[第 2 章｜讀懂一份陌生程式碼](../part-01-foundations/ch-02-reading-unfamiliar-code.md) ⸺ 第一個月「讀懂」階段的方法論在這裡
- **強連結**:[第 9 章｜重構的時機與安全網](../part-02-craft/ch-09-refactoring.md) ⸺ 第三階段漸進改善的實作技術
- **強連結**:[第 11 章｜可測試的程式碼設計](../part-03-testing/ch-11-testable-code.md) ⸺ 特徵測試怎麼設計讓它不脆弱
- **強連結**:[第 10 章｜程式碼層的技術債](../part-02-craft/ch-10-tech-debt.md) ⸺ 第一階段讀懂後,怎麼記錄和評估技術債
