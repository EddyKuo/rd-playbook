...
> **前置閱讀**:[第 45 章｜判斷力的養成](./ch-45-cultivating-judgment.md)
...
- **上一章**:[第 45 章｜判斷力的養成](./ch-45-cultivating-judgment.md) ⸺ 本章是第 45 章的延續,從「判斷力怎麼養成」到「把它放進整個成長路徑」
- **強連結**:[第 27 章｜向下穿透抽象層](../part-06-operations/ch-27-penetrating-abstraction.md) ⸺ 垂直穿透力的核心技術場景(本章 §46.2 PostgreSQL 案例的技術底層)
- **強連結**:[第 1 章｜為什麼工程實作需要決策框架](../part-01-foundations/ch-01-why-engineering-decisions.md) ⸺ 全書起點,從交付前四問到成長路徑的首尾呼應
- **參考**:[第 33 章｜快取設計與失效策略](../part-07-performance/ch-33-caching.md) ⸺ §46.2 Redis 穿透層案例的原始場景(CartNova)
