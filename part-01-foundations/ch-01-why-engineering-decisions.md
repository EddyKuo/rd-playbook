...
他讀了一遍,覺得邏輯通順;在本機跑了一下,資料正確;demo 給 PM 看,大家都點頭。於是這支功能順利上線了。那天他下班的時候,心情是很好的——又快又順,沒有什麼好不放心的。

我懂那種感覺。東西能跑、測試會過、別人也說好,你很自然會覺得「這件事做完了」。

可是三天後,事情來了。一個資料量很大的租戶按下匯出,整個資料庫的回應時間突然飆高,連帶影響了其他租戶。團隊緊急查了半天才發現:AI 生成的那段查詢,在資料量小的時候完全正常,但它會**一次把整張表撈出來**,既沒有分頁,也沒有用上租戶層級的索引。

小俊很懊惱地跟我說:「它明明能跑啊。」

我記得我當時沒有怪他。因為這件事真正的問題,不在他,也不完全在 AI。問題在於——**從頭到尾,沒有人在交付之前,問過那一句話:「它在我們最大的那個租戶身上,會怎麼樣?」**
...
下面這幾個地雷,坦白說,幾乎每個工程師都踩過,我自己也不例外。所以這裡不是要提醒你「別犯錯」,而是想讓你下次遇到的時候,心裡有個底。
...
> 修正方向:忙的時候,至少先問第②問(最壞負載)。在我的經驗裡,線上最痛的事故,很多都是栽在這一題。先守住它,其他的可以慢慢補。
