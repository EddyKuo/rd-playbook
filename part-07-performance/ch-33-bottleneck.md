...
> **前置閱讀**:[第 32 章｜效能量測先於優化](./ch-32-measure-first.md)
> **下游章節**:[第 34 章｜快取的層次與失效策略](./ch-34-caching.md)

---

## 33.1 共感現場:「它就是慢,先加快取吧」
...
- **下一章**:[第 34 章｜快取的層次與失效策略](./ch-34-caching.md) ⸺ 定位到 I/O 瓶頸或外部 API 慢之後,快取通常是第一個工具
- **前一章**:[第 32 章｜效能量測先於優化](./ch-32-measure-first.md) ⸺ 本章的前置:沒有量測就沒有基準,沒有基準就無法判斷優化是否有效
- **強連結**:[第 27 章｜從告警到根因:生產環境除錯](../part-06-operations/ch-27-alert-to-rootcause.md) ⸺ 除錯方法論「大膽假設、小心求證」和瓶頸定位共用同一套思路
- **強連結**:[第 26 章｜可觀測性落地](../part-06-operations/ch-26-observability.md) ⸺ USE 方法需要 metric/trace 的基礎建設才能運作
- **強連結**:[第 35 章｜並發、非同步與背壓](./ch-35-concurrency.md) ⸺ 鎖競爭定位之後,解法往往在這裡
