...
> **前置閱讀**:[第 12 章｜單元測試與 TDD 的落地](./ch-12-unit-tdd.md)
> **下游章節**:[第 14 章｜測試替身(mock/stub/fake)的取捨](./ch-14-test-doubles.md)
...
> **修正方向**:業務邏輯的邊界條件,還是回到單元測試去驗(第 12 章談過的)。整合測試只問一件事:「兩個東西接起來,資料有沒有流對?」越聚焦這個問題,整合測試就越乾淨。
...
### 13.5.1 範例:ClearPay 支付閘道與帳戶服務的契約
...
- **上一章**:[第 12 章｜單元測試與 TDD 的落地](./ch-12-unit-tdd.md) ⸺ 單元測試守業務邏輯,本章守服務邊界
- **下一章**:[第 14 章｜測試替身(mock/stub/fake)的取捨](./ch-14-test-doubles.md) ⸺ 契約測試裡用到的 stub/mock 選型深探
- **強連結**:[第 16 章｜與 CI 整合的測試流水線](./ch-16-ci-testing.md) ⸺ 把契約測試接入 CI 的具體做法
- **強連結**:[第 20 章｜跨團隊的介面契約與相依](../part-04-collaboration/ch-20-interface-contracts.md) ⸺ 從工程師層上升到團隊協作層的契約管理
- **跨書連結**:[SA/SD Playbook — 第 28 章｜測試策略設計](https://github.com/EddyKuo/sa-sd-playbook) ⸺ 架構高度的「為可測試性而設計」
