...
> **下游章節**:[第 15 章｜與 CI 整合的測試流水線](./ch-15-ci-pipeline.md)
...
- **下一章**:[第 15 章｜與 CI 整合的測試流水線](./ch-15-ci-pipeline.md) ⸺ 本章打好的環境隔離基礎,讓 CI 流水線能放心做平行化與快取
- **強連結**:[第 11 章｜單元測試與 TDD 的落地](./ch-11-unit-testing-tdd.md) ⸺ Builder 模式和固定種子在單元測試同樣適用
- **強連結**:[第 12 章｜契約測試與整合測試](./ch-12-contract-integration-testing.md) ⸺ 整合測試對環境一致性的需求最高,本章策略直接適用
