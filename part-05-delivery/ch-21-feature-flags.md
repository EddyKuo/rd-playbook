...
> **前置閱讀**:[第 20 章｜CI/CD 流水線設計](./ch-20-cicd-pipeline.md)
...
- **前一章**:[第 20 章｜CI/CD 流水線設計](./ch-20-cicd-pipeline.md) ⸺ Feature Flag 是 CI/CD 流水線的延伸,讓「持續部署」和「受控發布」同時成立
- **下一章**:[第 22 章｜藍綠/金絲雀部署](./ch-22-blue-green-canary.md) ⸺ 漸進式發布的另一個維度:在基礎設施層做流量切換
- **強連結**:[第 23 章｜回滾與前向修復決策](./ch-23-rollback-vs-forward-fix.md) ⸺ 功能旗標的 Kill Switch 是最輕量的回滾手段
