...
# 第 41 章｜AI 時代的工程師心智與責任界線
## ⸺ 當機器接手「寫」,「負責」這件事去了哪裡?

> **前置閱讀**:[第 36 章｜AI 輔助編碼的工作流重塑](./ch-36-ai-assisted-coding.md)、[第 40 章｜Prompt 與 context 作為工程產物](./ch-40-prompt-as-engineering-artifact.md)
> **下游章節**:[第 45 章｜判斷力的養成:當階梯被 AI 抽掉](../part-09-synthesis/ch-45-judgment-development.md)

## 41.1 共感現場:那個「反正 AI 說這樣就這樣」的下午
...
## 41.2 真正的問題:「Generate」和「Judge」被混在一起了
...
AI 生成的程式碼不是不好——它的問題通常不是「語法錯」,而是「在你的具體現實裡對不對」。小薇那段時區的問題,用任何時區計算邏輯都能寫得語法完美;但選哪個時區,只有了解客戶分布和合規定義的人才能做出正確的判斷。
...
AI 語言模型給出的回答,語氣上不會顯示「這個我不確定」——它的措辭在第一行和最後一行通常同樣流暢自信。這讓人很容易把「AI 寫得很完整」誤讀成「AI 已經考慮到所有角落」。小薇的時區問題就是這樣發生的:AI 的程式碼看起來這麼有組織、這麼完整,她的疑問就自然被壓下去了。
...
時區、金額計算、權限邊界、個資處理——這些功能有一個共同點:它們在開發環境的測試裡很難驗證出問題,但在現實裡出問題的代價非常高。AI 在這類功能上生成的程式碼「看起來最完整」,因為模式都在訓練資料裡;但「看起來完整」和「符合你的合規文件」之間,有一段只有你能走的路。
...
### 41.5.1 範例:ClearTrade 合規轉帳功能的確認單
...
- **前一章**:[第 40 章｜Prompt 與 context 作為工程產物](./ch-40-prompt-as-engineering-artifact.md) ⸺ 工程師對 AI 的輸入端責任
- **下一章**:[第 42 章｜從設計到上線:一個完整功能的實作全紀錄](../part-09-synthesis/ch-42-feature-end-to-end.md) ⸺ 把本章心智付諸實踐
- **強連結**:[第 1 章｜為什麼工程實作需要決策框架](../part-01-foundations/ch-01-why-engineering-decisions.md) ⸺ Generate vs Judge 論述的起點
- **強連結**:[第 37 章｜審查 AI 生成的程式碼](./ch-37-reviewing-ai-code.md) ⸺ 判斷力在程式碼審查層面的具體實踐
- **強連結**:[第 45 章｜判斷力的養成:當階梯被 AI 抽掉](../part-09-synthesis/ch-45-judgment-development.md) ⸺ 本章的判斷力如何長出來
