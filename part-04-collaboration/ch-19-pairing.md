...
> **前置閱讀**:[第 17 章｜Code Review：看什麼、怎麼給回饋](./ch-17-code-review.md)、[第 18 章｜Pull Request 的拆分與描述](./ch-18-pull-request.md)
> **下游章節**:[第 20 章｜跨團隊的介面契約與相依](./ch-20-interface-contracts.md)
...
問題出在哪裡?駕駛這個角色,要同時做兩件事:「打字」和「思考邏輯」——兩件事一起做,認知負擔本來就是最高的。導航者只需要做一件事:「觀察並提問」,負擔輕得多。新人剛接觸一個系統時,腦子裡本來就沒有多少餘裕,如果又要他一邊打字一邊想邏輯,自然只剩下「別打錯字」的餘裕。

順著這個道理,更有效的做法是反過來——讓資深者當駕駛、新人當導航者。新人唯一的工作變成「說出疑惑」,不需要完成任何執行動作,這樣他才有餘裕安全地思考邏輯,而不是提心吊膽地打字。當導航者,新人可以自在地說「這個 condition 是什麼意思?」資深者解釋,雙方都學到東西。等新人對脈絡有基本掌握之後,再換他試試駕駛——這時候壓力小得多,因為他已經知道方向了。
...
駕駛的工作是「執行」,認知負擔最高——要同時處理「打字」和「思考邏輯」;導航者的工作是「思考和提問」,認知負擔低得多,因為不需要同時完成任何動作。

> 修正方向:新人 onboarding 的時候,讓資深者當駕駛、新人當導航者,反而更有效。新人做導航者時,可以把更多腦力用在理解邏輯上,而不是糾結於「我打字對不對」——這才是真正的學習,而不是表演。等到新人對脈絡有基本掌握之後,再讓他試試駕駛。(這個建議和 §19.3.1 的情境一呼應——設計好的結對情境,是讓新人安全地問問題,而不是安全地打字。)
...
後來這個試用期升降方案的退費規則,PM 給了明確答案,但牽涉到的邊界情境比原本想的還多——小云、阿澤,再加上剛好在場的 QA 婷婷,索性拉了一個 45 分鐘的迷你 Mob session,把 §19.3.2 那套節奏縮小版套用進來:

```text
14:00–14:05  開場:三人對齊今天的具體問題——
              「把試用期中途升降方案的退費規則,轉成可測試的邊界清單」
14:05–14:25  工作塊:小云駕駛,寫分攤邏輯的骨架;
              阿澤導航提問計費規則細節,婷婷導航記下每個邊界情境
              → 婷婷在第 12 分鐘問:「試用期結束當天升方案算哪一邊?」
                三人當場對齊:算新方案生效日,不算試用期
14:25–14:27  輪換:阿澤接手駕駛,先用自己的話覆述目前進度
14:27–14:45  工作塊:阿澤駕駛,補上升降方案的分攤運算;
              小云和婷婷導航,婷婷把每個決定即時轉成測試案例草稿
```

45 分鐘後,三個人對這段邏輯有了同樣的理解,婷婷手上也已經有一份初版的邊界情境清單可以直接轉成測試案例——不用等 PR 開出來,QA 再回頭問「這個邊界你們討論過嗎」。
...
- **前一章**:[第 18 章｜Pull Request 的拆分與描述](./ch-18-pull-request.md) ⸺ PR 是結對的自然後續,兩者互補
- **下一章**:[第 20 章｜跨團隊的介面契約與相依](./ch-20-interface-contracts.md) ⸺ 協作從二人延伸到跨團隊
- **強連結**:[第 17 章｜Code Review：看什麼、怎麼給回饋](./ch-17-code-review.md) ⸺ Review 與結對的適用場景對比
- **強連結**:[第 46 章｜判斷力的養成](../part-09-synthesis/ch-46-cultivating-judgment.md) ⸺ 結對是刻意養成判斷力的重要機制
