...
# 第 17 章｜Code Review:看什麼、怎麼給回饋
## ⸺ 評審的目的不是找錯,而是讓整個團隊走得更遠

> **前置閱讀**:[第 16 章｜與 CI 整合的測試流水線](../part-03-testing/ch-16-ci-testing.md)
> **下游章節**:[第 18 章｜Pull Request 的拆分與描述](./ch-18-pull-request.md)

## 17.1 共感現場:那條「看起來沒問題」的 comment
...
## 17.5 帶得走的工具 ⸺ 一頁式「Review Checklist」
...
- **下一章**:[第 18 章｜Pull Request 的拆分與描述](./ch-18-pull-request.md) ⸺ review 的品質從 PR 描述就開始了
- **強連結**:[第 6 章｜可讀性:為下一個人而寫](../part-02-craft/ch-06-readability.md) ⸺ 第二層鏡頭(可讀性)的深度展開
- **強連結**:[第 7 章｜命名、抽象與邊界](../part-02-craft/ch-07-naming-abstraction.md) ⸺ 命名回饋的理論基礎
- **強連結**:[第 38 章｜審查 AI 生成的程式碼](../part-08-ai-era/ch-38-reviewing-ai-code.md) ⸺ 三層鏡頭用在 AI 產出上
