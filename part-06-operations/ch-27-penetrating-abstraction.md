...
part: VI
title: 向下穿透抽象層
slug: ch-27-penetrating-abstraction
agent: RD
...
> **前置閱讀**:[第 25 章｜可觀測性落地](./ch-25-observability.md)、[第 26 章｜從告警到根因](./ch-26-alert-to-root-cause.md)
> **下游章節**:[第 28 章｜On-call 與事故處理](./ch-28-oncall.md)、[第 45 章｜判斷力的養成](../part-09-capstone/ch-45-judgment-growth.md)
...
- **上一章**:[第 26 章｜從告警到根因](./ch-26-alert-to-root-cause.md) ⸺ 本章的前半段:如何從 alert 開始收斂
- **下一章**:[第 28 章｜On-call 與事故處理](./ch-28-oncall.md) ⸺ 把穿透力用在生產事故的即時決策
- **強連結**:[第 25 章｜可觀測性落地](./ch-25-observability.md) ⸺ 穿透需要工具;metrics/trace/log 是你的觀測眼
- **強連結**:[第 45 章｜判斷力的養成](../part-09-capstone/ch-45-judgment-growth.md) ⸺ 「被逼著下降的肌肉」如何在 AI 時代刻意培養
- **強連結**:[第 36 章｜AI 輔助編碼的工作流重塑](../part-08-ai-era/ch-36-ai-coding-workflow.md) ⸺ vibe-debugging 反模式的完整討論
