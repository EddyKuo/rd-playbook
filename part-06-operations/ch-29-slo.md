...
一個常見的誤區是把 SLO 設得越高越好。但 SLO 有一個隱藏的代價:越高的目標,越小的錯誤預算,意味著**越少的空間做任何會有風險的事**。所以 SLO 應該反映的是「客戶真正需要的可靠性」,而不是「工程師覺得應該達到的完美」。
...
- 這類服務的重點在於:數字太小時容易「看不見」——你可能在月底才發現三次小中斷累積快把預算燒完
