...
# 第 30 章｜SLO 與錯誤預算的實作面
## ⸺ 從「不能掛」到「可以掛多少」的思維轉換

> **前置閱讀**:[第 26 章｜可觀測性落地(log/metric/trace)](./ch-26-observability.md)、[第 29 章｜On-call 與事故處理](./ch-29-on-call.md)
> **下游章節**:[第 31 章｜災難復原演練](./ch-31-disaster-recovery.md)
...
## 30.3 一起做判斷:從 SLI 到燃燒率告警

那麼,這條因果鏈實際上怎麼搭建?我們一步一步來。

### 30.3.1 第一步:定義 SLI — 量什麼?從哪裡量?
...
> 修正方向:根據燃燒率的嚴重程度分層告警(如 §30.3.4 的表格)。P1 才值得半夜喚醒;P2 第二天工作時間處理就夠了。「緊急程度分層」是告警可靠性的基礎。
...
### 30.5.1 範例:LucidPay 轉帳服務的 SLO 卡
...
- **上一章**:[第 29 章｜On-call 與事故處理](./ch-29-on-call.md) ⸺ SLO 提供了判斷事故嚴重程度的數字基礎
- **下一章**:[第 31 章｜災難復原演練](./ch-31-disaster-recovery.md) ⸺ 把「接受失敗」的態度付諸演練
- **強連結**:[第 26 章｜可觀測性落地](./ch-26-observability.md) ⸺ SLI 的量測數據來自 metric pipeline
- **強連結**:[第 27 章｜從告警到根因](./ch-27-alert-to-rootcause.md) ⸺ 燃燒率告警觸發後的偵錯流程
